        ...
        <div id="main">
            ...
            <div class="page-heading">
                ...
                <div>
                    ...
                    <form action="<?php echo e(route('Obat.update',$data->id)); ?>" onsubmit="validateForm()" method="POST" enctype="multipart/form-data" id="form">
                        <?php echo csrf_field(); ?>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-5 form-group">
                                                                <input type="text" id="brand" class="form-control"
                                                                    name="brand" value="<?php echo e($data->brand); ?>">
                                                            </div>
                                                            ...
                                                            <div class="col-md-5 form-group">
                                                                <input type="text" class="form-control" id="category"
                                                                    name="category" value="<?php echo e($data->category); ?>">
                                                            </div>
                                                            ...
                                                            <div class="col-md-5 form-group">
                                                                <input type="text" class="form-control" id="satuan"
                                                                    name="satuan" value="<?php echo e($data->satuan); ?>">
                                                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u1578562/public_html/pengingatobat.com/resources/views/obat/edit.blade.php ENDPATH**/ ?>