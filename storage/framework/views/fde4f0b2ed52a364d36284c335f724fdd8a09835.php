                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            ...
                            <form action="/pasienupdate/<?php echo e($getDataDetails->id_pasien); ?>" method="POST" class="form" data-parsley-validate>
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="city-column" class="form-control" placeholder="Alamat" name="alamat" data-parsley-required="true" value="<?php echo e($getDataDetails->alamat); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="country-floating" class="form-control" name="tempatlahir" placeholder="Tempat Lahir" data-parsley-required="true" value="<?php echo e($getDataDetails->tempatlahir); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="company-column" class="form-label">Tanggal lahir</label>
                                            <input type="date" id="company-column" class="form-control" name="tgllahir" placeholder="Tanggal Lahir"  value="<?php echo e($getDataDetails->tgllahir); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="city-column" class="form-label">No Ktp</label>
                                            <input type="number" id="city-column" class="form-control" placeholder="No Ktp" name="no_ktp" data-parsley-required="true" value="<?php echo e($getDataDetails->no_ktp); ?>">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group mandatory">
                                            <label for="email-id-column" class="form-label">Kota</label>
                                            <input type="text" id="last-name-column" class="form-control" placeholder="Nama Passien" name="kota" data-parsley-required="true" value="<?php echo e($getDataDetails->kota); ?>">
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\patientmedication\resources\views/pasien/update.blade.php ENDPATH**/ ?>