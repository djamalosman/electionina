                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                            <div class="form-group">
                                                <?php $__currentLoopData = $kecamatan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $valcamat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <input hidden value="<?php echo e($valcamat->idcamat); ?>" id="kecamatan_id" name="kecamatan_id">
                                                    <h6 class="mb-0 ms-3">Provinsi : <?php echo e($valcamat->provinsi); ?></h6>
                                                    <h6 class="mb-0 ms-3">Kota : <?php echo e($valcamat->kota_kabupaten); ?></h6>
                                                    <h6 class="mb-0 ms-3">Kecamatan : <?php echo e($valcamat->namacamat); ?></h6>
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 col-xxl-12">
                                            <div class="form-group">
                                                <select class="choices form-select" id="partai_id" name="partai_id">
                                                    ...
                                                    <?php $__currentLoopData = $partai; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $valpartai): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($valpartai->id_partai); ?>"><?php echo e($valpartai->name_partai); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group">
                                                <select class="choices form-select" id="selectDesa" name="selectDesa">
                                                    ...
                                                    <?php $__currentLoopData = $desa; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $valdesa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($valdesa->iddesa); ?>"><?php echo e($valdesa->namadesa); ?> </option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                        </div>
...
<script src="<?php echo e('assets/extensions/chart.js/Chart.min.js'); ?>"></script>
<script src="<?php echo e('assets/js/pages/ui-chartjs.js'); ?>"></script>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\electionina\resources\views/home.blade.php ENDPATH**/ ?>