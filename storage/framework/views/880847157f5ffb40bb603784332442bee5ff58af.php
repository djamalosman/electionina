                ...
                <section class="section">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="<?php echo e(route('Schedule.create')); ?>" type="button" id="create"
                                ...
                                <div class="table-responsive">
                                    <table class="table" id="table1">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?php echo e($no++); ?></td>
                                                <td> <a href="<?php echo e(url('/Schedule/edit/' . $header->id)); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u1578562/public_html/pengingatobat.com/resources/views/schedule/index.blade.php ENDPATH**/ ?>