                ...
                <section class="section">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a href="<?php echo e(route('Pasien.create')); ?>" type="button" id="create"
                                ...
                                <div class="table-responsive">
                                    <table class="table" id="table1">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?php echo e($no++); ?></td>
                                                <td> <a href="<?php echo e(url('/Pasien/edit/' . $header->id)); ?>"
                                                ...
                                                <td><?php echo e($header->phone); ?></td>                                       
                                                <td><?php echo e($header->tempat); ?></td>                                       
                                                <td><?php echo e(date('Y-m-d'),strtotime($header->tgllahir)); ?></td>                                       
                                                <td><?php echo e($header->kota); ?></td>  
                                                <td><?php echo e($header->ktp); ?></td>
...
<script src="<?php echo e(asset('assets/js/pages/datatables.js')); ?>"></script>
    ...
    <script>
        ...
        $('body').on('click', '#btn-delete-post', function() {
            let id = $(this).data('id');
            var base_url = "<?php echo e(url('/Pasien/')); ?>";
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u1578562/public_html/pengingatobat.com/resources/views/pasien/index.blade.php ENDPATH**/ ?>