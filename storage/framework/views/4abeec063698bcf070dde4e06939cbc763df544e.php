                                        ...
                                        <div class="card-content">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    <label for="helpInputTop">Jam Pagi Minum Obat</label>
                                                            ...
                                                            <input type="time" class="form-control" id="datepagi" name="datepagi[]"  value="00:00">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="time" class="form-control" id="datesiang" name="datesiang[]" value="00:00">
                                                </div>
                                                <div class="form-group">
                                                    <label for="disabledInput">Jam Malam Minum Obat</label>
                                                    
                                                    <input type="time" class="form-control" id="datesiang" name="datemalam[]" value="00:00">
                                                </div>
                                                <div class="form-group">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u1578562/public_html/pengingatobat.com/resources/views/schedule/create.blade.php ENDPATH**/ ?>