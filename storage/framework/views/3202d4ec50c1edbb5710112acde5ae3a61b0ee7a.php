                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="date" class="form-control" id="stardate"
                                                                                    ...
                                                                                    name="stardate[]" value="<?php echo e(date('Y-m-d'),strtotime($val->stardate)); ?>">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="disabledInput">Tanggal Akhir Minum Obat</label>
                                                                            <input type="date" class="form-control" id="enddate"
                                                                            name="enddate[]" value="<?php echo e(date('Y-m-d'),strtotime($val->enddate)); ?>">
                                                                        </div>
                                                                    </div>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                    <div class="col-md-6">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u1578562/public_html/pengingatobat.com/resources/views/schedule/edit.blade.php ENDPATH**/ ?>