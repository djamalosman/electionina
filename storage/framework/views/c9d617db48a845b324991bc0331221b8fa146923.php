        ...
        <div id="main">
            ...
            <div class="page-heading">
                ...
                <div>
                    ...
                    <form action="<?php echo e(route('Pasien.store')); ?>" onsubmit="validateForm()" method="POST" enctype="multipart/form-data" id="form">
                        <?php echo csrf_field(); ?>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-5 form-group">
                                                                <input type="password" value="123"  class="form-control" id="password"
                                                                    name="password" required disabled>
                                                            </div>
                                                            <div class="col-md-1">
                                                                <label>Alamat</label>
                                                            </div>
                                                            ...
                                                            <div class="col-md-5 form-group">
                                                                <input type="date" class="form-control" id="tgllahir"
                                                                    name="tgllahir" value="<?php echo e(now()->format('Y-m-d')); ?>">
                                                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u1578562/public_html/pengingatobat.com/resources/views/pasien/create.blade.php ENDPATH**/ ?>